<?php
/**
 * Plugin Name: CF Layout Blocks
 * Description: Blocos de layout criados exclusivamente para o site CF
 * Author: MinimalQ
...
// Core constants 
define("PLUGIN_DIR", plugin_dir_path(__DIR__) . "cf-blocks/");
define("PLUGIN_URL", plugins_url("cf-blocks/"));
define("PLUGIN_CLASS", "CF_Blocks");

/**
 * CF Blocks plugin
 */
final class CF_Blocks {
